    ...
    <header>
        <div class="header">
            <div class="header-top">
                <div class="container">
                    <a class="login" href="../AWET1/pages/login.php"> <span class="glyphicon glyphicon-lock"></span> Login</a> &
                    <a class="login" href="form-validation.php">Register</a> |
